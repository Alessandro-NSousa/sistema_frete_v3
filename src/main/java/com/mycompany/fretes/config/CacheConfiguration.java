package com.mycompany.fretes.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mycompany.fretes.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mycompany.fretes.repository.UserRepository.USERS_BY_EMAIL_CACHE);
