...
import com.mycompany.fretes.repository.ClienteRepository;
...
class ClienteResourceIT {
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nome(UPDATED_NOME).telefone(UPDATED_TELEFONE).telefoneAdicional(UPDATED_TELEFONE_ADICIONAL).cnpj(UPDATED_CNPJ);
